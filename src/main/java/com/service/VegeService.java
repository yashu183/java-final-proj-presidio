...
public class VegeService {
	...
	public void addingVeges() {
		...
		VegeDTOimpl vegedaoimpl = new VegeDTOimpl();
		vegedaoimpl.addVege(vegeshop1);
		vegedaoimpl.addVege(vegeshop2);
		vegedaoimpl.addVege(vegeshop3);
		vegedaoimpl.addVege(vegeshop4);
	}
}
