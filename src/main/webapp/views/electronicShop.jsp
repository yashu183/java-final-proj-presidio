...
<%@page import="com.entity.ElectronicsShop"%>
...
<%
List<ElectronicsShop> vegelist = (List)request.getAttribute("fruitlis");
	for(int i = 0; i < vegelist.size(); i++){
		String name = (String)vegelist.get(i).getEname();
		int price = (int)vegelist.get(i).getEprice();
		String img = (String)vegelist.get(i).getEimg();
		String des = (String)vegelist.get(i).getEdes();
		String id = (String)vegelist.get(i).getEid();
