...
<nav style="position : sticky; top : 0; z-index:1;" class="navbar  navbar-expand-md navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="#">Fruits</a>	
        </li>
        <li class="nav-item">
       ...
       if(httpsession.getAttribute("admin") == null || httpsession.getAttribute("selecteditemslist") == null){
...
<%
	List<FruitsShop> vegelist = (List)request.getAttribute("fruitlis");
	for(int i = 0; i < vegelist.size(); i++){
		String name = (String)vegelist.get(i).getFname();
		int price = (int)vegelist.get(i).getFprice();
		String img = (String)vegelist.get(i).getFimg();
		String des = (String)vegelist.get(i).getFdes();
		String id = (String)vegelist.get(i).getFid();
