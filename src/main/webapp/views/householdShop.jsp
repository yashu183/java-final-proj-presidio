...
<nav style="position : sticky; top : 0; z-index:1;" class="navbar  navbar-expand-md navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="#">HouseHolds</a> 
        </li>
        <li class="nav-item">
...
<%
	List<HouseHoldUtensils> vegelist = (List)request.getAttribute("fruitlis");
	for(int i = 0; i < vegelist.size(); i++){
		String name = (String)vegelist.get(i).getHname();
		int price = (int)vegelist.get(i).getHprice();
		String img = (String)vegelist.get(i).getHimg();
		String des = (String)vegelist.get(i).getHdes();
		String id = (String)vegelist.get(i).getHid();
